...
final class ReobfServer {
    ...
    private void remap(final IMappingFile mappings) {
        ...
        LOGGER.info(ANSI_GREEN + ICON_LOADING + "  Remapeando o servidor..." + ANSI_RESET);
        ...
        LOGGER.info(ICON_SUCCESS + " " + ANSI_GREEN + " Remapeamento do servidor concluído em {}ms." + ANSI_RESET, System.currentTimeMillis() - startRemap);
